...
<body>
	...
	<form:form action="create" method="POST" modelAttribute="item">
      ...
      Item Dimensions :: <form:input path="itemWidth" size="5" /> W <form:input path="itemLength"  size="5"/> L <form:input path="itemHeight" size="5"/> H
      		<%-- <form:errors path="itemDimensions" /> --%>     
       ...
       Item Vendors :<form:select path="venUsers" multiple="true">
       				<form:option value="">--SELECT--</form:option>
       				<form:options items="${vendors}" itemValue="id" itemLabel="code"/>
